...
type lazyLogging func(logger *zap.SugaredLogger)
...
func (sl *schedulerLogger) VLazy(lvl int, lazyLogger lazyLogging) {
	if sl.logLevel >= lvl {
		lazyLogger(sl.getLogger())
	}
}
